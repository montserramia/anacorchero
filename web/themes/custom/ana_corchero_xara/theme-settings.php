...
function ana_corchero_xara_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  $image_folder = $GLOBALS['base_url'] . '/' . \Drupal::service('extension.list.theme')->getPath('ana_corchero_xara') . '/images/theme-settings/';
  $button = "display: inline-block; background: #0984e3; color: white; margin-bottom: 10px; padding: 5px 10px";
  $ana_corchero_xarapro = '<img src="' . $image_folder . 'ana_corchero_xarapro.jpg" />';
	$form['#attached']['library'][] = 'ana_corchero_xara/theme-settings';
  $form['ana_corchero_xara'] = [
    '#type'       => 'vertical_tabs',
  ...
  $form['general']['general_info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Theme Info'),
    '#description' => t('<a href="https://drupar.com/theme/ana_corchero_xara" target="_blank">Theme Homepage</a> || <a href="https://demo2.drupar.com/ana_corchero_xara/" target="_blank">Theme Demo</a> || <a href="https://drupar.com/doc/ana_corchero_xara" target="_blank">Theme Documentation</a> || <a href="https://drupar.com/doc/ana_corchero_xara/support" target="_blank">Theme Support</a>'),
  ];
  $form['general']['general_info_upgrade'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Upgrade To XaraPro for $29 only'),
    '#description' => t('<p><a href="https://drupar.com/theme/ana_corchero_xarapro" target="_blank">Purchase XaraPro</a> || <a href="https://demo2.drupar.com/ana_corchero_xarapro/" target="_blank">XaraPro Demo</a></p>') . $ana_corchero_xarapro,
  ];
  /*
   * Layout
   */
  ...
  $form['layout']['layout_container']['container_width'] = [
    '#type'          => 'number',
    '#default_value' => theme_get_setting('container_width', 'ana_corchero_xara'),
  ...
  $form['layout']['layout_header']['header_width'] = [
    ...
    '#default_value' => theme_get_setting('header_width', 'ana_corchero_xara'),
  ];
  // Layout -> Main Layout
  ...
  $form['layout']['layout_main']['main_width'] = [
    ...
    '#default_value' => theme_get_setting('main_width', 'ana_corchero_xara'),
  ];
  ...
  $form['layout']['layout_footer']['footer_width'] = [
    ...
    '#default_value' => theme_get_setting('footer_width', 'ana_corchero_xara'),
  ];
  /*
   * Homepage slider
   */
  ...
  $form['slider']['slider_enable_option']['slider_show'] = [
    ...
    '#default_value' => theme_get_setting('slider_show', 'ana_corchero_xara'),
  ...
  $form['slider']['slider_speed_option']['slider_speed'] = [
    ...
    '#default_value' => theme_get_setting('slider_speed', 'ana_corchero_xara'),
  ...
  $form['slider']['slider_image_section']['slider_image'] = [
    ...
    '#default_value'  => theme_get_setting('slider_image', 'ana_corchero_xara'),
    '#description'   => t('Xara theme has limitation of single image for slider. Separate image for each slide is available in XaraPro. <a href="https://drupar.com/theme/ana_corchero_xarapro" target="_blank">Buy XaraPro for $29 only.</a>'),
  ];
  $form['slider']['slider_code'] = [
    '#type'          => 'textarea',
    '#title'         => t('Slider Code'),
    '#default_value' => theme_get_setting('slider_code', 'ana_corchero_xara'),
    '#description'   => t('Please refer to this <a href="https://drupar.com/doc/ana_corchero_xara/homepage-slider" target="_blank">documentation page</a> for slider code tutorial.'),
  ];
  /*
   * Header
   */
  ...
  $form['header']['header_links'] = [
    ...
    '#description'   => t('<a href="https://drupar.com/doc/ana_corchero_xara/how-manage-website-logo" target="_blank">Change Logo</a> || <a href="https://drupar.com/doc/ana_corchero_xara/how-change-favicon-icon" target="_blank">Change Favicon Icon</a> || <a href="https://drupar.com/doc/ana_corchero_xara/header-main-menu" target="_blank">Manage Main Menu</a> || <a href="https://drupar.com/doc/ana_corchero_xara/sliding-search-form" target="_blank">Sliding Search Form</a>'),
    '#group' => 'header_tab',
  ];
  ...
  $form['header']['header_page']['header_page_position_section']['header_page_content_position'] = [
    ...
    '#default_value' => theme_get_setting('header_page_content_position', 'ana_corchero_xara'),
  ...
  $form['sidebar']['front_sidebars']['front_sidebar_section']['front_sidebar'] = [
    ...
    '#default_value' => theme_get_setting('front_sidebar', 'ana_corchero_xara'),
  ...
  $form['sidebar']['sidebar_width']['sidebar_width_default_section']['sidebar_width_default'] = [
    ...
    '#default_value' => theme_get_setting('sidebar_width_default', 'ana_corchero_xara'),
  ...
  $form['sidebar']['sidebar_width']['sidebar_width_section']['sidebar_width_left'] = [
    ...
    '#default_value' => theme_get_setting('sidebar_width_left', 'ana_corchero_xara'),
  ...
  $form['sidebar']['sidebar_width']['sidebar_width_section']['sidebar_width_right'] = [
    ...
    '#default_value' => theme_get_setting('sidebar_width_right', 'ana_corchero_xara'),
  ...
  $form['content']['shortcodes'] = [
    '#type'          => 'details',
    '#title'         => t('Shortcodes'),
    '#description'   => t('<p>ana_corchero_xara theme has many custom shortcodes which you can use for creating contents.</p><p>Please visit this page for list of all available shortcodes and how to use these shortcodes.</p><ul><li><a href="https://drupar.com/node/2017/" target="_blank">XARA Shortcodes</a></li><li><a href="https://drupar.com/node/1211/" target="_blank">The-X Shortcodes</a></li></ul><p><hr /></p><h4>More Shortcodes</h4><p><a href="https://drupar.com/theme/ana_corchero_xarapro">XaraPro</a> has more custom shortcodes like Tab, Accordion, icon box, card, Model etc.'),
    '#group' => 'content_tab',
  ];
  // content -> RTL
  ...
  $form['content']['content_direction']['rtl'] = [
    ...
    '#default_value' => theme_get_setting('rtl', 'ana_corchero_xara'),
  ...
  $form['content']['animated_content']['animated_content_section'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Animated Page Content - ana_corchero_xaraPro Feature'),
    '#description'   => t('<p>With animated page content shortcodes, you can create contents with animation effects. These contents will appear with some animation effect when it will come in browser view.</p><p></p>'),
  ];
  ...
  $form['content']['submitted_details']['node_author_pic_section']['node_author_pic'] = [
    ...
    '#default_value' => theme_get_setting('node_author_pic', 'ana_corchero_xara'),
  ...
  $form['content']['submitted_details']['node_tags_section']['node_tags'] = [
    ...
    '#default_value' => theme_get_setting('node_tags', 'ana_corchero_xara'),
  ...
  $form['footer']['copyright']['copyright_text'] = [
    ...
    '#default_value' => theme_get_setting('copyright_text', 'ana_corchero_xara'),
    '#description'   => t("Check this option to show website copyright text in footer. Uncheck to hide.<br />Read more: <a href='https://drupar.com/doc/ana_corchero_xara/copyright-text-footer' target='_blank'>Copyright Text in Footer</a>"),
  ];
  ...
  $form['comment']['comment_photo']['comment_user_pic'] = [
    ...
    '#default_value' => theme_get_setting('comment_user_pic', 'ana_corchero_xara'),
  ...
  $form['comment']['comment_author']['highlight_author_comment'] = [
    ...
    '#default_value' => theme_get_setting('highlight_author_comment', 'ana_corchero_xara'),
  ...
  $form['comment']['comment_author']['highlight_author_color'] = [
    ...
    '#description'   => t('Color option is available in the premium version of this theme. <a href="https://drupar.com/theme/ana_corchero_xarapro" target="_blank">Buy XaraPro for $29 only.</a>'),
    '#open' => TRUE,
  ];
  ...
  $form['typography']['body']['body_font_size_section']['body_font_size'] = [
    ...
    '#default_value' => theme_get_setting('body_font_size', 'ana_corchero_xara'),
  ...
  $form['elements']['main_menu']['main_menu_default_section']['main_menu_default'] = [
    ...
    '#default_value' => theme_get_setting('main_menu_default', 'ana_corchero_xara'),
  ...
  $form['elements']['main_menu']['main_menu_top']['main_menu_top_size'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Font Size (rem)'),
    '#default_value' => theme_get_setting('main_menu_top_size', 'ana_corchero_xara'),
  ...
  $form['elements']['main_menu']['main_menu_top']['main_menu_top_weight'] = [
    ...
    '#default_value' => theme_get_setting('main_menu_top_weight', 'ana_corchero_xara'),
  ...
  $form['elements']['main_menu']['main_menu_top']['main_menu_top_transform'] = [
    ...
    '#default_value' => theme_get_setting('main_menu_top_transform', 'ana_corchero_xara'),
  ...
  $form['elements']['main_menu']['main_menu_sub']['main_menu_sub_size'] = [
    ...
    '#step' => 0.1,
    '#title'  => t('Font Size (rem)'),
    '#default_value' => theme_get_setting('main_menu_sub_size', 'ana_corchero_xara'),
    '#description'   => t("Default value is <strong>1rem</strong>.<br />1 rem = 16px<br /><p><hr /></p>"),
  ];
  $form['elements']['main_menu']['main_menu_sub']['main_menu_sub_weight'] = [
    ...
    '#default_value' => theme_get_setting('main_menu_sub_weight', 'ana_corchero_xara'),
    '#description'   => t("Default value is <strong>700</strong>.<br /><p><hr /></p>"),
  ];
  $form['elements']['main_menu']['main_menu_sub']['main_menu_sub_transform'] = [
    ...
    '#default_value' => theme_get_setting('main_menu_sub_transform', 'ana_corchero_xara'),
    '#description'   => t("Default value is <strong>None</strong>."),
  ];
  ...
  $form['elements']['page_title']['page_title_default_section']['page_title_default'] = [
    ...
    '#default_value' => theme_get_setting('page_title_default', 'ana_corchero_xara'),
  ...
  $form['elements']['page_title']['page_title_size_section']['page_title_size'] = [
    ...
    '#default_value' => theme_get_setting('page_title_size', 'ana_corchero_xara'),
  ...
  $form['elements']['page_title']['page_title_transform_section']['page_title_transform'] = [
    ...
    '#default_value' => theme_get_setting('page_title_transform', 'ana_corchero_xara'),
    '#description'   => t("Default value is <strong>None</strong>."),
  ];
  /*
   * Components
  ...
  $form['components']['fonts']['fonts_section']['font_src'] = [
    ...
    '#default_value' => theme_get_setting('font_src', 'ana_corchero_xara'),
    '#description'   => t('ana_corchero_xara theme uses following Google fonts: Noto Sans.<br />You can serve these fonts locally or from Google server.'),
  ];
  // Components -> Social
  ...
  $form['components']['social']['all_icons']['social_icons_show'] = [
    ...
    '#default_value' => theme_get_setting('social_icons_show', 'ana_corchero_xara'),
  ...
  $form['components']['social']['social_profile']['facebook']['facebook_url'] = [
    ...
    '#default_value' => theme_get_setting('facebook_url', 'ana_corchero_xara'),
  ];
  ...
  $form['components']['social']['social_profile']['twitter']['twitter_url'] = [
    ...
    '#default_value' => theme_get_setting('twitter_url', 'ana_corchero_xara'),
  ];
  ...
  $form['components']['social']['social_profile']['instagram']['instagram_url'] = [
    ...
    '#default_value' => theme_get_setting('instagram_url', 'ana_corchero_xara'),
  ];
  ...
  $form['components']['social']['social_profile']['linkedin']['linkedin_url'] = [
    ...
    '#default_value' => theme_get_setting('linkedin_url', 'ana_corchero_xara'),
  ];
  ...
  $form['components']['social']['social_profile']['youtube']['youtube_url'] = [
    ...
    '#default_value' => theme_get_setting('youtube_url', 'ana_corchero_xara'),
  ];
  ...
  $form['components']['social']['social_profile']['vimeo']['vimeo_url'] = [
    ...
    '#default_value' => theme_get_setting('vimeo_url', 'ana_corchero_xara'),
  ];
  ...
  $form['components']['social']['social_profile']['telegram']['telegram_url'] = [
    ...
    '#default_value' => theme_get_setting('telegram_url', 'ana_corchero_xara'),
  ];
  ...
  $form['components']['social']['social_profile']['whatsapp']['whatsapp_url'] = [
    ...
    '#default_value' => theme_get_setting('whatsapp_url', 'ana_corchero_xara'),
  ];
  ...
  $form['components']['social']['social_profile']['github']['github_url'] = [
    ...
    '#default_value' => theme_get_setting('github_url', 'ana_corchero_xara'),
  ];
  ...
  $form['components']['social']['social_profile']['vk']['vk_url'] = [
      ...
      '#default_value' => theme_get_setting('vk_url', 'ana_corchero_xara'),
  ];
  $form['components']['node_share'] = [
    '#type'        => 'details',
    '#title'       => t('Share Page'),
    '#description'   => t('<h4>Share Page On Social networking websites</h4><p></p>'),
    '#group' => 'components_tab',
  ];
  ...
  $form['components']['font_icons']['fontawesome4']['fontawesome_four'] = [
    ...
    '#default_value' => theme_get_setting('fontawesome_four', 'ana_corchero_xara'),
  ...
  $form['components']['font_icons']['fontawesome5']['fontawesome_five'] = [
    ...
    '#default_value' => theme_get_setting('fontawesome_five', 'ana_corchero_xara'),
  ...
  $form['components']['font_icons']['fontawesome6']['fontawesome_six'] = [
    ...
    '#default_value' => theme_get_setting('fontawesome_six', 'ana_corchero_xara'),
    '#description'   => t(''),
  ...
  $form['components']['font_icons']['bootstrap_icons']['bootstrapicons'] = [
    ...
    '#default_value' => theme_get_setting('bootstrapicons', 'ana_corchero_xara'),
  ...
  $form['components']['font_icons']['materialicons'] = [
    ...
    '#description'   => t('This feature is available in the premium version of this theme. <a href="https://drupar.com/theme/ana_corchero_xarapro" target="_blank">Purchase XaraPro for $29 only.</a>'),
  ];
  ...
  $form['components']['scrolltotop']['scrolltotop_enable']['scrolltotop_on'] = [
    ...
    '#default_value' => theme_get_setting('scrolltotop_on', 'ana_corchero_xara'),
  ...
  $form['insert_codes']['head'] = [
    '#type'        => 'details',
    '#title'       => t('Head'),
    '#description' => t('<h3>Insert Codes Before &lt;/HEAD&gt;</h3><p><hr /></p>'),
  ...
  $form['insert_codes']['css']['css_section']['styling'] = [
    ...
    '#default_value' => theme_get_setting('styling', 'ana_corchero_xara'),
    '#description'   => t("Check this option to enable custom styling. Uncheck to disable this feature.<br />Please refer to this tutorial page. <a href='https://drupar.com/doc/ana_corchero_xara/custom-css' target='_blank'>How To Use Custom Styling</a>"),
  ];
  ...
  $form['insert_codes']['css']['css_section']['styling_code'] = [
    ...
    '#default_value' => theme_get_setting('styling_code', 'ana_corchero_xara'),
    '#description'   => t('Please enter your custom css codes in this text box. You can use it to customize the appearance of your site.<br />Please refer to this tutorial for detail: <a href="https://drupar.com/doc/ana_corchero_xara/custom-css" target="_blank">Custom CSS</a>'),
  ];
  ...
  $form['support']['info'] = [
    ...
    <p>Please check our documentation for detailed information on how to use ana_corchero_xara theme.<br /><a href="https://drupar.com/doc/ana_corchero_xara" target="_blank">Xara Documentation</a>.</p>
    <h4>The-X Documentation</h4>
    <p>ana_corchero_xara theme uses The-X theme as the base theme. So, many things are covered in <a href="https://drupar.com/doc/thex" target="_blank">The X Documentation</a>.</p>
    <hr />
    <h4>Create Issue</h4>
    <p>If you need support that is beyond our theme documentation, please <a href="https://www.drupal.org/project/issues/ana_corchero_xara?status=All&categories=All" target="_blank">Create an issue</a> at project page.</p>
    <hr />
    <h4>Contact Us</h4>
  ...
  $form['upgrade']['info'] = [
    '#type'        => 'fieldset',
    '#title'       => t('<p><a href="https://demo2.drupar.com/ana_corchero_xarapro/" target="_blank">XaraPro Demo</a> | <a href="https://drupar.com/theme/ana_corchero_xarapro" target="_blank">Purchase XaraPro for $29 only</a></p>'),
    '#description' => t("$ana_corchero_xarapro"),
  ];
// End form.
}
